...
tranferencias = {
    'HashTransferenciaUnica':{
        'CPF_Origem': {'Id_banco': 'Itau', 'Valor': 'valor', 'data/hora': 'data/hora'},
        'CPF_destino': {'Id_banco': 'Itau', 'Valor': 'valor', 'data/hora': 'data/hora'}
        }
}

depositos = {
    'HashTransferenciaUnica':{
        'data/hora': {'agencia': 'agencia', 'conta':'conta', 'Valor': 'valor'}
}